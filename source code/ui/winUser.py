...
"}")
        ...
        self.pushButton_3 = QPushButton(self.pagePayment)
        self.pushButton_3.setObjectName(u"pushButton_3")
        self.pushButton_3.setGeometry(QRect(570, 460, 81, 26))
        self.label = QLabel(self.pagePayment)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(260, 150, 91, 61))
        ...
        self.stackedContent.setCurrentIndex(4)
    ...
    def retranslateUi(self, winUser):
        ...
        self.pushButton_3.setText(QCoreApplication.translate("winUser", u"3", None))
        self.label.setText(QCoreApplication.translate("winUser", u"thanh to\u00e1n", None))
